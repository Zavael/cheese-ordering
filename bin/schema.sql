...
(
  ...
  "item_id" integer REFERENCES "items" ("item_id") ON DELETE NO ACTION ON UPDATE NO ACTION
)
WITH (
  autovacuum_enabled=true)
;
...
(
  ...
  "order_date" Date,
  "customer_id" integer REFERENCES "customers" ("customer_id") ON DELETE NO ACTION ON UPDATE NO ACTION
)
WITH (
  autovacuum_enabled=true)
;
...
(
  ...
  "amount" integer,
  "item_id" integer REFERENCES "items" ("item_id") ON DELETE NO ACTION ON UPDATE NO ACTION,
  "order_id" integer REFERENCES "orders" ("order_id") ON DELETE NO ACTION ON UPDATE NO ACTION
)
WITH (
  autovacuum_enabled=true)
;
