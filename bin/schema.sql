...
(
  ...
  "item_id" integer REFERENCES "items" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
)
WITH (
  autovacuum_enabled=true)
;
...
(
  ...
  "date" Date,
  "customer_id" integer REFERENCES "customers" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
)
WITH (
  autovacuum_enabled=true)
;
...
(
  ...
  "amount" integer,
  "item_id" integer REFERENCES "items" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,
  "order_id" integer REFERENCES "orders" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION
)
WITH (
  autovacuum_enabled=true)
;
